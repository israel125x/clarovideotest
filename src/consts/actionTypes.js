...
export const SEARCH_MOVIE_ALL_START ='SEARCH_MOVIE_ALL_START';
export const SEARCH_MOVIE_ALL_ERROR ='SEARCH_MOVIE_ALL_ERROR';
export const SEARCH_MOVIE_ALL_COMPLETE ='SEARCH_MOVIE_ALL_COMPLETE';
